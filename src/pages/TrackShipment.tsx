                    ...
                    <div className="errorBox">
                      ...
                      <div className="error-content">
                        ...
                        <div className="errorSuggestions">
                          ...
                          <ul>
                            <li>
                              Your shipment ID is correct and belongs to your
                              account
                            </li>
                            <li>
                              The shipment has been processed and is in the
                              system
                            </li>
                    ...
                    <div className="resultsHeaderBox">
                      <div className="resultsHeader">
                        <div className="header-content">
                          ...
                          <p className="shipmentIdText">
                            Shipment ID: {searchedShipmentId}
                          </p>
                        </div>
                        {trackingData.TrackingStatus &&
                          trackingData.TrackingStatus.length > 0 && (
                ...
                {!trackingData && !loading && !error && (
                  <div className="emptyStateBox">
                    <div className="emptyState">
                      ...
                      <p>
                        Enter your shipment ID above to get real-time tracking
                        information for shipments belonging to your account
                      </p>
                    </div>
                  </div>
                )}
